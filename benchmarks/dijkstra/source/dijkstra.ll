...
; <label>:94:                                     ; preds = %37
  ...
  call void @print_path(%struct._NODE* getelementptr inbounds ([100 x %struct._NODE], [100 x %struct._NODE]* @rgnNodes, i32 0, i32 0), i32 %95)
  br label %96

; <label>:96:                                     ; preds = %94, %25
...
; <label>:15:                                     ; preds = %2
  ...
  %17 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %16, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.2, i32 0, i32 0))
  %18 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8
  %19 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %18, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.3, i32 0, i32 0))
  br label %20
...
; <label>:20:                                     ; preds = %15, %2
  ...
  %24 = call %struct._IO_FILE* @fopen(i8* %23, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i32 0, i32 0))
...
; <label>:32:                                     ; preds = %29
  ...
  %34 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %33, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.5, i32 0, i32 0), i32* %8)
  %35 = load i32, i32* %8, align 4
  %36 = load i32, i32* %6, align 4
  %37 = sext i32 %36 to i64
  %38 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* @AdjMatrix, i64 0, i64 %37
...
; <label>:64:                                     ; preds = %50
  %65 = call i32 @gettimeofday(%struct.timeval* %11, %struct._NODE* null) #3
  %66 = getelementptr inbounds %struct.timeval, %struct.timeval* %11, i32 0, i32 0
  %67 = load i64, i64* %66, align 8
  %68 = getelementptr inbounds %struct.timeval, %struct.timeval* %10, i32 0, i32 0
  %69 = load i64, i64* %68, align 8
  %70 = sub nsw i64 %67, %69
  %71 = mul nsw i64 %70, 1000
  %72 = getelementptr inbounds %struct.timeval, %struct.timeval* %11, i32 0, i32 1
  %73 = load i64, i64* %72, align 8
  %74 = getelementptr inbounds %struct.timeval, %struct.timeval* %10, i32 0, i32 1
  %75 = load i64, i64* %74, align 8
  %76 = sub nsw i64 %73, %75
  %77 = sdiv i64 %76, 1000
  %78 = add nsw i64 %71, %77
  %79 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.6, i32 0, i32 0), i64 %78)
