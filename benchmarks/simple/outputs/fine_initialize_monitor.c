...
void initialize_monitor_routine(unsigned int node_id)
{
	...
	add_basicblock(p_integrated_CFG, 0x170003, 2, 0x2, 0x17000b);
	...
	add_basicblock(p_integrated_CFG, 0x17000a, 1, 0x1, 0x170003);
	add_basicblock(p_integrated_CFG, 0x17000b, 1, 0x1, 0x17000c);
	add_basicblock(p_integrated_CFG, 0x17000c, 1, 0x1, 0x17000d);
	add_basicblock(p_integrated_CFG, 0x17000d, 1, 0x1, 0x17000e);
	add_basicblock(p_integrated_CFG, 0x17000e, 4, 0x2, 0x0);
	add_basicblock(p_integrated_CFG, 0x17000e, 4, 0x2, 0x0);
