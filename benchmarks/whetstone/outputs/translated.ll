...
; <label>:359:                                    ; preds = %357
  ...
  %360 = getelementptr inbounds %struct.timeval, %struct.timeval* %29, i32 0, i32 0
  %361 = load i64, i64* %360, align 8
  %362 = getelementptr inbounds %struct.timeval, %struct.timeval* %28, i32 0, i32 0
  %363 = load i64, i64* %362, align 8
  %364 = sub nsw i64 %361, %363
  %365 = mul nsw i64 %364, 1000
  %366 = getelementptr inbounds %struct.timeval, %struct.timeval* %29, i32 0, i32 1
  %367 = load i64, i64* %366, align 8
  %368 = getelementptr inbounds %struct.timeval, %struct.timeval* %28, i32 0, i32 1
  %369 = load i64, i64* %368, align 8
  %370 = sub nsw i64 %367, %369
  %371 = sdiv i64 %370, 1000
  %372 = add nsw i64 %365, %371
  %373 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), i64 %372)
  br label %374
