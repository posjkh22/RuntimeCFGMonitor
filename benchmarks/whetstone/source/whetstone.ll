...
define i32 @main() #0 {
  ...
  store i64 100000, i64* %23, align 8
...
; <label>:343:                                    ; preds = %337
  ...
  %345 = getelementptr inbounds %struct.timeval, %struct.timeval* %29, i32 0, i32 0
  %346 = load i64, i64* %345, align 8
  %347 = getelementptr inbounds %struct.timeval, %struct.timeval* %28, i32 0, i32 0
  %348 = load i64, i64* %347, align 8
  %349 = sub nsw i64 %346, %348
  %350 = mul nsw i64 %349, 1000
  %351 = getelementptr inbounds %struct.timeval, %struct.timeval* %29, i32 0, i32 1
  %352 = load i64, i64* %351, align 8
  %353 = getelementptr inbounds %struct.timeval, %struct.timeval* %28, i32 0, i32 1
  %354 = load i64, i64* %353, align 8
  %355 = sub nsw i64 %352, %354
  %356 = sdiv i64 %355, 1000
  %357 = add nsw i64 %350, %356
  %358 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), i64 %357)
  ret i32 0
}
